      ...
      if (result?.error) {
        switch (result.error) {
          case 'CredentialsSignin':
            ...
            break
          case 'AccessDenied':
            setFormError('Access denied. You do not have permission to access this resource.')
            break
          default:
            setFormError(result.error || 'An error occurred during sign in. Please try again.')
        }
      } else if (result?.url) {
